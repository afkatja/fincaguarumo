...
export type SupportedLanguage = "en" | "nl" | "es" | "ru" | "de"
...
/**
 * Language-specific stop words for filtering
 */
...
export function preprocessText(
  ...
  if (removeStopWords && detectedLanguage !== "unknown") {
    const stopWords = STOP_WORDS[detectedLanguage as SupportedLanguage]
