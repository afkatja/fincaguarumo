...
export class VectorStoreAdapter {
  ...
  async semanticSearch(
    ...
    if (this.useQdrant) {
      return qdrantStore.semanticSearch(query, options)
    } else {
  ...
  async hybridSearch(
    ...
    if (this.useQdrant) {
      return qdrantStore.hybridSearch(query, options)
    } else {
  ...
  async findSimilarContent(
    ...
    if (this.useQdrant) {
      return qdrantStore.findSimilarContent(contentId, contentType, options)
    } else {
  ...
  async storeBatchEmbeddings(
    ...
    if (this.useQdrant) {
      ...
      return embeddingFunctions.storeBatchEmbeddings(embeddings)
    }
  }
  ...
  async embeddingExists(
    ...
    if (this.useQdrant) {
      ...
      return pgvectorStore.embeddingExists(contentId, contentType)
    }
  }
