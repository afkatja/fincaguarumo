  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].range-end)]:rounded-r-md rounded-md font-normal aria-selected:opacity-100 hover:cursor-pointer",
          props.mode === "range"
        ...
        day_button: cn(
          ...
          "w-full h-full p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 transition-colors duration-200 hover:cursor-pointer hover:translate-y-0 hover:bg-gray-100",
        ),
        range_start:
