...
// Variable: HOME_QUERY
// Query: *[_type=='home' && language == $language][0] {    hero, subtitle, language,    'translations': *[      _type == "translation.metadata" &&       ^._id in translations[].value._ref    ][0].translations[]{      ...(value->{        hero, subtitle, language      })    }  }
